...
CREATE TABLE Order_Details ( order_detail_id INT PRIMARY KEY, FOREIGN KEY (order_id) REFERENCES Orders(order_id), book_id REFERENCES Books(book_id), quantity DOUBLE NOT NULL)
